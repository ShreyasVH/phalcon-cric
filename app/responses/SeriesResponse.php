...
class SeriesResponse
{
    ...
    public function __construct(int $id, string $name, CountryResponse $country, TourResponse $tour_response, SeriesTypeResponse $series_type_response, GameTypeResponse $game_type_response, $start_time, array $teams, array $players)
    {
        $this->id = $id;
        $this->name = $name;
    ...
    public static function withAllData(Series $series, CountryResponse $country, TourResponse $tour, SeriesTypeResponse $type, GameTypeResponse $game_type, array $teams, array $players)
    {
